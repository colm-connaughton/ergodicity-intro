...
To avoid giving the impression that infinite ergodicity is a complicated way of describing properties of random walks that are obtainable by other means, it is worth briefly considering a completely
different example: the Pomeau-Manneville map. 
This is a deterministic dynamical system on a compact state space where the mechanism for generation of an infinite invariant measure is quite different.
The map is
\begin{align}
